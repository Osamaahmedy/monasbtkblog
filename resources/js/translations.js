export const translations = {
    en: {
        ...
        admin: {
            ...
            dashboard: {
                title: 'Control Panel',
                subtitle: "Monitor your platform's performance and content seamlessly.",
                totalArticles: 'Total Articles',
                activeCategories: 'Active Categories',
                pendingComments: 'Pending Comments',
                welcomeTitle: 'Manage your platform',
                welcomeSubtitle: 'with ease & style.',
                welcomeDesc: 'Create beautiful articles, organize them into categories, and moderate reader comments all from one unified interface.',
                createArticle: 'Create Article',
                viewLibrary: 'View Library',
                quickActions: 'Quick Actions',
                manageCategories: 'Manage Categories',
                organizeStructure: 'Organize your structure',
                reviewComments: 'Review Comments',
                moderateFeedback: 'Moderate reader feedback',
                profileSettings: 'Profile Settings',
                manageAccount: 'Manage your account',
            },
            articles: {
                title: 'Articles',
                manage: 'Manage your publications',
                ...
                startByCreating: 'Get started by creating a new article.',
            ...
            categories: {
                title: 'Categories',
                manage: 'Manage and organize your article categories',
                total: 'total',
                ...
                startByCreating: 'Get started by creating your first category.',
            ...
            comments: {
                ...
                subtitle: 'Review and moderate user feedback',
                ...
                confirmApproveSelected: 'Approve selected?',
                confirmPendingSelected: 'Mark as pending?',
                confirmSpamSelected: 'Mark as spam?',
                confirmDeleteSelected: 'Delete selected? Cannot be undone.',
                showLess: 'Show less ↑',
                readMore: 'Read more ↓',
                noComments: 'No comments found',
                adjustFilters: 'Try adjusting your filters.',
                engageDesc: 'Comments will appear here when users engage with your articles.',
                clearFilters: 'Clear filters →',
            },
            articleForm: {
                createTitle: 'Create Article',
                createDesc: 'Write and publish a new article',
                ...
                imageRequirements: 'PNG, JPG, WebP – max 2MB',
                draftSaved: 'Draft saved',
                restoreDraft: '💾 Restore Draft',
                heightLabel: 'Height',
                copyBtn: '📋 Copy',
                clearBtn: '🗑 Clear',
                quillPlaceholder: 'Write your article content here...',
                wordsLabel: 'Words',
                charsLabel: 'Chars',
                minRead: 'min read',
                ...
                tip1: '• Use H2/H3 headings for structure',
                tip2: '• Aim for 300+ words per article',
                tip3: '• Fill both EN and AR content',
                tip4: '• Drafts autosave every 1.2s',
                tip5: '• Use blockquotes for important text',
                englishContentRequired: 'English content is required',
                arabicContentRequired: 'Arabic content is required',
            },
            categoryForm: {
                createTitle: 'Create Category',
                createDesc: 'Add a new category to organize your articles',
                editTitle: 'Edit Category',
                editDesc: 'Update category information and image',
            ...
            profile: {
                ...
                desc: 'Manage your profile, security, and team',
    ...
    ar: {
        ...
        admin: {
            ...
            dashboard: {
                title: 'لوحة التحكم',
                subtitle: 'تابع أداء منصتك ومحتواها بسلاسة وبساطة.',
                totalArticles: 'إجمالي المقالات',
                activeCategories: 'الأقسام النشطة',
                pendingComments: 'التعليقات المعلقة',
                welcomeTitle: 'أدر منصتك',
                welcomeSubtitle: 'بكل سهولة وأناقة.',
                welcomeDesc: 'أنشئ مقالات رائعة، ورتبها في أقسام، وأدر تعليقات القراء كلها من واجهة واحدة موحدة.',
                createArticle: 'إنشاء مقال',
                viewLibrary: 'عرض المكتبة',
                quickActions: 'إجراءات سريعة',
                manageCategories: 'إدارة الأقسام',
                organizeStructure: 'تنظيم الهيكل الخاص بك',
                reviewComments: 'مراجعة التعليقات',
                moderateFeedback: 'إدارة تعليقات القراء',
                profileSettings: 'إعدادات الملف الشخصي',
                manageAccount: 'إدارة حسابك الشخصي',
            },
            articles: {
                title: 'المقالات',
                manage: 'إدارة منشوراتك ومقالاتك',
                ...
                startByCreating: 'ابدأ بكتابة مقال جديد.',
                createFirst: 'أنشئ مقالك الأول ←',
                confirmDelete: 'هل أنت متأكد من حذف هذا المقال؟ لا يمكن التراجع عن هذا الإجراء.',
            ...
            categories: {
                title: 'الأقسام',
                manage: 'إدارة وتنظيم أقسام المقالات',
                total: 'إجمالي',
                ...
                startByCreating: 'ابدأ بإنشاء قسمك الأول لتصنيف المقالات.',
                createFirst: 'أنشئ قسمك الأول ←',
                confirmDelete: 'هل أنت متأكد من حذف هذا القسم؟ لا يمكن التراجع عن هذا الإجراء.',
            },
            comments: {
                title: 'إدارة التعليقات',
                subtitle: 'مراجعة وإدارة تعليقات وملاحظات القراء',
                pendingReview: 'معلق بانتظار المراجعة',
                ...
                confirmApproveSelected: 'هل تريد قبول التعليقات المحددة؟',
                confirmPendingSelected: 'هل تريد تعليق التعليقات المحددة؟',
                confirmSpamSelected: 'هل تريد تحديد التعليقات المحددة كرسائل مزعجة؟',
                confirmDeleteSelected: 'هل تريد حذف التعليقات المحددة؟ لا يمكن التراجع عن هذا الإجراء.',
                showLess: 'عرض أقل ↑',
                readMore: 'اقرأ المزيد ↓',
                noComments: 'لم يتم العثور على تعليقات',
                adjustFilters: 'حاول ضبط خيارات التصفية.',
                engageDesc: 'ستظهر التعليقات هنا عندما يتفاعل المستخدمون مع مقالاتك المنشورة.',
                clearFilters: 'إلغاء التصفية ←',
            },
            articleForm: {
                createTitle: 'إنشاء مقال',
                createDesc: 'اكتب وانشر مقالاً جديداً',
                editTitle: 'تعديل مقال',
                backBtn: 'رجوع',
                viewLive: 'عرض مباشر',
                featuredImage: 'الصورة البارزة',
                optional: '(اختياري)',
                leaveEmpty: '(اتركه فارغاً للاحتفاظ بالصورة الحالية)',
                changeImage: 'تغيير الصورة',
                clickToUpload: 'اضغط لرفع الصورة',
                imageRequirements: 'PNG, JPG, WebP – الحد الأقصى 2 ميجابايت',
                draftSaved: 'تم حفظ المسودة',
                restoreDraft: '💾 استعادة المسودة',
                heightLabel: 'الارتفاع',
                copyBtn: '📋 نسخ',
                clearBtn: '🗑 مسح',
                quillPlaceholder: 'اكتب محتوى المقالة هنا...',
                wordsLabel: 'الكلمات',
                charsLabel: 'الحروف',
                minRead: 'دقائق قراءة',
                publishSettings: 'إعدادات النشر',
                statusLabel: 'الحالة',
                publishedOption: '✅ منشور',
                draftOption: '📝 مسودة',
                schedulePublish: 'جدولة النشر',
                publishImmediately: 'نشر فوري',
                publishDate: 'تاريخ ووقت النشر',
                scheduleTitle: 'إعدادات الجدولة',
                categoryLabel: 'القسم',
                selectCategory: 'اختر القسم',
                savingBtn: 'جاري الحفظ...',
                saveChanges: 'حفظ التغييرات',
                publishArticle: 'نشر المقال',
                writingTips: 'نصائح الكتابة',
                tip1: '• استخدم ترويسات H2/H3 لتقسيم المقال',
                tip2: '• احرص على أن لا تقل المقالة عن 300 كلمة',
                tip3: '• املأ المحتوى باللغتين الإنجليزية والعربية',
                tip4: '• تحفظ المسودات تلقائياً كل 1.2 ثانية',
                tip5: '• استخدم الاقتباسات للنصوص المهمة',
                englishContentRequired: 'المحتوى الإنجليزي مطلوب',
                arabicContentRequired: 'المحتوى العربي مطلوب',
            },
            categoryForm: {
                createTitle: 'إنشاء قسم',
                createDesc: 'أضف قسماً جديداً لتنظيم مقالاتك',
                editTitle: 'تعديل قسم',
                editDesc: 'تحديث معلومات وصورة القسم',
                backToCategories: 'العودة إلى الأقسام',
                categoryDetails: 'تفاصيل القسم',
                fillInfo: 'املأ المعلومات أدناه',
                ...
                uploadNewImage: 'رفع صورة جديدة (اختياري)',
            ...
            profile: {
                ...
                desc: 'إدارة ملفك الشخصي والأمان وفريق العمل',
                profileInfoTab: 'معلومات الحساب',
                passwordTab: 'كلمة المرور',
                manageUsersTab: 'إدارة المستخدمين',
                fullName: 'الاسم الكامل',
                fullNamePlaceholder: 'اسمك',
                email: 'البريد الإلكتروني',
                emailPlaceholder: 'you@example.com',
                emailUnverified: 'بريدك الإلكتروني غير مفعّل.',
                saving: 'جاري الحفظ...',
                saveChanges: 'حفظ التغييرات',
                saved: 'تم الحفظ!',
