...
const TiktokIcon = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M16.6 5.82s.51.5 0 0A4.278 4.278 0 0 1 15.54 3h-3.09v12.4a2.592 2.592 0 1 1-1.8-2.46V9.98a5.68 5.68 0 0 0-2.5-.5A5.75 5.75 0 0 0 2.5 15.19 5.75 5.75 0 0 0 8.25 20.94a5.75 5.75 0 0 0 5.75-5.75V8.83a7.34 7.34 0 0 0 4.6 1.6V7.34a4.85 4.85 0 0 1-2-1.52z" />
  </svg>
);
...
const SOCIAL_LINKS = [
  ...
  {
   key: 'tiktok',
   href: 'https://www.tiktok.com/@monasbtkapp',
   icon: TiktokIcon,
   label: 'TikTok',
   hover: 'hover:bg-black hover:text-white',
  },
