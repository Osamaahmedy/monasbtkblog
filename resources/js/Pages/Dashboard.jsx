...
export default function Dashboard({ stats }) {
    ...
    const statCards = [
        { 
            name: t.admin.dashboard.totalArticles, 
        ...
        { 
            name: t.admin.dashboard.activeCategories, 
        ...
        { 
            name: t.admin.dashboard.pendingComments, 
            ...
            header={
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-slate-500 font-mikhak-regular mt-1 text-sm">{t.admin.dashboard.subtitle}</p>
                    </div>
                    <div className="flex items-center px-4 py-2 bg-emerald-50 rounded-full border border-emerald-100/60 shadow-sm w-fit">
                        <span className={`flex h-2 w-2 relative ${lang === 'ar' ? 'ml-2' : 'mr-2'}`}>
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                        </span>
                        <span className="text-xs font-mikhak-bold text-emerald-700 uppercase tracking-wider">{t.admin.sidebar.systemOnline}</span>
                    </div>
                </div>
            }
        >
            <Head title={t.admin.sidebar.dashboard} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-3 relative rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-xl group min-h-[340px] flex flex-col justify-center">
                        ...
                        <div className="relative z-10 p-6 sm:p-10 lg:p-12 flex flex-col justify-center">
                            <span 
                                className="inline-block px-3.5 py-1.5 rounded-full border text-xs font-mikhak-medium mb-6 w-max animate-pulse"
                                style={{
                            ...
                            <h3 className="text-3xl sm:text-4xl font-mikhak-bold text-white mb-4 leading-tight">
                                {t.admin.dashboard.welcomeTitle} <br /> 
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                >
                                    <svg className={`w-5 h-5 ${lang === 'ar' ? 'ml-2' : 'mr-2'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="lg:col-span-2 bg-white border border-slate-100 rounded-[2rem] sm:rounded-[2.5rem] shadow-sm p-6 sm:p-8 flex flex-col relative overflow-hidden">
                        ...
                        <h3 className="text-xl font-mikhak-bold text-slate-800 mb-6 relative z-10">{t.admin.dashboard.quickActions}</h3>
                        
                        <div className="space-y-4 relative z-10 flex-1">
                            {[
                                { 
                                    name: t.admin.dashboard.manageCategories, 
                                    desc: t.admin.dashboard.organizeStructure, 
                                ...
                                { 
                                    name: t.admin.dashboard.reviewComments, 
                                    desc: t.admin.dashboard.moderateFeedback, 
                                ...
                                { 
                                    name: t.admin.dashboard.profileSettings, 
                                    desc: t.admin.dashboard.manageAccount, 
                                ...
                                <Link 
                                    key={idx}
                                    href={item.href}
                                    className={`flex items-center p-4 rounded-2xl bg-white border border-slate-100/80 shadow-sm hover:shadow-md transition-all group ${item.hoverBorder} rtl:space-x-reverse`}
                                >
                                    ...
                                    <div className={`${lang === 'ar' ? 'mr-4' : 'ml-4'} flex-1 overflow-hidden`}>
                                    ...
                                    <div className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                                        <svg className={`w-4 h-4 transition-transform ${lang === 'ar' ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
