import{b as x,v as Xe,j as t,$ as Je,Y as j}from"./app-DKo9POMY.js";import{r as Ke,i as Qe,f as C,c as _,a as Me,b as Te,J as Ze,p as et,v as tt,d as rt,e as nt,g as ot,n as We,h as st,s as at,u as A,j as _e,w as it,k as $,M as Ae,l as M,m as b}from"./proxy-DzOqIHh4.js";import{A as lt}from"./index-lGtCe3Ku.js";const S=new WeakMap;let v;const He=(e,n,r)=>(o,s)=>s&&s[0]?s[0][e+"Size"]:Qe(o)&&"getBBox"in o?o.getBBox()[n]:o[r],ct=He("inline","width","offsetWidth"),dt=He("block","height","offsetHeight");function pt({target:e,borderBoxSize:n}){var r;(r=S.get(e))==null||r.forEach(o=>{o(e,{get width(){return ct(e,n)},get height(){return dt(e,n)}})})}function mt(e){e.forEach(pt)}function ft(){typeof ResizeObserver>"u"||(v=new ResizeObserver(mt))}function ht(e,n){v||ft();const r=Ke(e);return r.forEach(o=>{let s=S.get(o);s||(s=new Set,S.set(o,s)),s.add(n),v==null||v.observe(o)}),()=>{r.forEach(o=>{const s=S.get(o);s==null||s.delete(n),s!=null&&s.size||v==null||v.unobserve(o)})}}const E=new Set;let N;function xt(){N=()=>{const e={get width(){return window.innerWidth},get height(){return window.innerHeight}};E.forEach(n=>n(e))},window.addEventListener("resize",N)}function ut(e){return E.add(e),N||xt(),()=>{E.delete(e),!E.size&&typeof N=="function"&&(window.removeEventListener("resize",N),N=void 0)}}function gt(e,n){return typeof e=="function"?ut(e):ht(e,n)}function Oe(e,n){let r;const o=()=>{const{currentTime:s}=n,l=(s===null?0:s.value)/100;r!==l&&e(l),r=l};return C.preUpdate(o,!0),()=>_(o)}function bt(...e){const n=!Array.isArray(e[0]),r=n?0:-1,o=e[0+r],s=e[1+r],i=e[2+r],l=e[3+r],c=Me(s,i,l);return n?c(o):c}function vt(e,n,r){const o=e.get();let s=null,i=o,l;const c=typeof o=="string"?o.replace(/[\d.-]/g,""):void 0,f=()=>{s&&(s.stop(),s=null)},m=()=>{f(),s=new Ze({keyframes:[je(e.get()),je(i)],velocity:e.getVelocity(),type:"spring",restDelta:.001,restSpeed:.01,...r,onUpdate:l})};e.attach((u,g)=>(i=u,l=y=>g(ke(y,c)),C.postRender(m),e.get()),f);let h;return Te(n)&&(h=n.on("change",u=>e.set(ke(u,c))),e.on("destroy",h)),h}function ke(e,n){return n?e+n:e}function je(e){return typeof e=="number"?e:parseFloat(e)}const wt=50,Ne=()=>({current:0,offset:[],progress:0,scrollLength:0,targetOffset:0,targetLength:0,containerLength:0,velocity:0}),yt=()=>({time:0,x:Ne(),y:Ne()}),kt={x:{length:"Width",position:"Left"},y:{length:"Height",position:"Top"}};function Ce(e,n,r,o){const s=r[n],{length:i,position:l}=kt[n],c=s.current,f=r.time;s.current=e[`scroll${l}`],s.scrollLength=e[`scroll${i}`]-e[`client${i}`],s.offset.length=0,s.offset[0]=0,s.offset[1]=s.scrollLength,s.progress=et(0,s.scrollLength,s.current);const m=o-f;s.velocity=m>wt?0:tt(s.current-c,m)}function jt(e,n,r){Ce(e,"x",n,r),Ce(e,"y",n,r),n.time=r}function Nt(e,n){const r={x:0,y:0};let o=e;for(;o&&o!==n;)if(rt(o))r.x+=o.offsetLeft,r.y+=o.offsetTop,o=o.offsetParent;else if(o.tagName==="svg"){const s=o.getBoundingClientRect();o=o.parentElement;const i=o.getBoundingClientRect();r.x+=s.left-i.left,r.y+=s.top-i.top}else if(o instanceof SVGGraphicsElement){const{x:s,y:i}=o.getBBox();r.x+=s,r.y+=i;let l=null,c=o.parentNode;for(;!l;)c.tagName==="svg"&&(l=c),c=o.parentNode;o=l}else break;return r}const W={start:0,center:.5,end:1};function ze(e,n,r=0){let o=0;if(e in W&&(e=W[e]),typeof e=="string"){const s=parseFloat(e);e.endsWith("px")?o=s:e.endsWith("%")?e=s/100:e.endsWith("vw")?o=s/100*document.documentElement.clientWidth:e.endsWith("vh")?o=s/100*document.documentElement.clientHeight:e=s}return typeof e=="number"&&(o=n*e),r+o}const Ct=[0,0];function zt(e,n,r,o){let s=Array.isArray(e)?e:Ct,i=0,l=0;return typeof e=="number"?s=[e,e]:typeof e=="string"&&(e=e.trim(),e.includes(" ")?s=e.split(" "):s=[e,W[e]?e:"0"]),i=ze(s[0],r,o),l=ze(s[1],n),i-l}const Bt={All:[[0,0],[1,1]]},$t={x:0,y:0};function Lt(e){return"getBBox"in e&&e.tagName!=="svg"?e.getBBox():{width:e.clientWidth,height:e.clientHeight}}function St(e,n,r){const{offset:o=Bt.All}=r,{target:s=e,axis:i="y"}=r,l=i==="y"?"height":"width",c=s!==e?Nt(s,e):$t,f=s===e?{width:e.scrollWidth,height:e.scrollHeight}:Lt(s),m={width:e.clientWidth,height:e.clientHeight};n[i].offset.length=0;let h=!n[i].interpolate;const u=o.length;for(let g=0;g<u;g++){const y=zt(o[g],m[l],f[l],c[i]);!h&&y!==n[i].interpolatorOffsets[g]&&(h=!0),n[i].offset[g]=y}h&&(n[i].interpolate=Me(n[i].offset,nt(o),{clamp:!1}),n[i].interpolatorOffsets=[...n[i].offset]),n[i].progress=ot(0,1,n[i].interpolate(n[i].current))}function Et(e,n=e,r){if(r.x.targetOffset=0,r.y.targetOffset=0,n!==e){let o=n;for(;o&&o!==e;)r.x.targetOffset+=o.offsetLeft,r.y.targetOffset+=o.offsetTop,o=o.offsetParent}r.x.targetLength=n===e?n.scrollWidth:n.clientWidth,r.y.targetLength=n===e?n.scrollHeight:n.clientHeight,r.x.containerLength=e.clientWidth,r.y.containerLength=e.clientHeight}function Mt(e,n,r,o={}){return{measure:s=>{Et(e,o.target,r),jt(e,r,s),(o.offset||o.target)&&St(e,r,o)},notify:()=>n(r)}}const B=new WeakMap,Be=new WeakMap,T=new WeakMap,$e=e=>e===document.scrollingElement?window:e;function Ie(e,{container:n=document.scrollingElement,...r}={}){if(!n)return We;let o=T.get(n);o||(o=new Set,T.set(n,o));const s=yt(),i=Mt(n,e,s,r);if(o.add(i),!B.has(n)){const c=()=>{for(const u of o)u.measure(st.timestamp);C.preUpdate(f)},f=()=>{for(const u of o)u.notify()},m=()=>C.read(c);B.set(n,m);const h=$e(n);window.addEventListener("resize",m,{passive:!0}),n!==document.documentElement&&Be.set(n,gt(n,m)),h.addEventListener("scroll",m,{passive:!0}),m()}const l=B.get(n);return C.read(l,!1,!0),()=>{var m;_(l);const c=T.get(n);if(!c||(c.delete(i),c.size))return;const f=B.get(n);B.delete(n),f&&($e(n).removeEventListener("scroll",f),(m=Be.get(n))==null||m(),window.removeEventListener("resize",f))}}const Le=new Map;function Tt(e){const n={value:0},r=Ie(o=>{n.value=o[e.axis].progress*100},e);return{currentTime:n,cancel:r}}function Fe({source:e,container:n,...r}){const{axis:o}=r;e&&(n=e);const s=Le.get(n)??new Map;Le.set(n,s);const i=r.target??"self",l=s.get(i)??{},c=o+(r.offset??[]).join(",");return l[c]||(l[c]=!r.target&&at()?new ScrollTimeline({source:n,axis:o}):Tt({container:n,...r})),l[c]}function Wt(e,n){const r=Fe(n);return e.attachTimeline({timeline:n.target?void 0:r,observe:o=>(o.pause(),Oe(s=>{o.time=o.duration*s},r))})}function _t(e){return e.length===2}function At(e,n){return _t(e)?Ie(r=>{e(r[n.axis].progress,r)},n):Oe(e,Fe(n))}function Ht(e,{axis:n="y",container:r=document.scrollingElement,...o}={}){if(!r)return We;const s={axis:n,container:r,...o};return typeof e=="function"?At(e,s):Wt(e,s)}function Se(e,n){it(!!(!n||n.current))}const Ot=()=>({scrollX:$(0),scrollY:$(0),scrollXProgress:$(0),scrollYProgress:$(0)});function It({container:e,target:n,layoutEffect:r=!0,...o}={}){const s=A(Ot);return(r?_e:x.useEffect)(()=>(Se("target",n),Se("container",e),Ht((l,{x:c,y:f})=>{s.scrollX.set(c.current),s.scrollXProgress.set(c.progress),s.scrollY.set(f.current),s.scrollYProgress.set(f.progress)},{...o,container:(e==null?void 0:e.current)||void 0,target:(n==null?void 0:n.current)||void 0})),[e,n,JSON.stringify(o.offset)]),s}function De(e){const n=A(()=>$(e)),{isStatic:r}=x.useContext(Ae);if(r){const[,o]=x.useState(e);x.useEffect(()=>n.on("change",o),[])}return n}function Ve(e,n){const r=De(n()),o=()=>r.set(n());return o(),_e(()=>{const s=()=>C.preRender(o,!1,!0),i=e.map(l=>l.on("change",s));return()=>{i.forEach(l=>l()),_(o)}}),r}function Ft(e){M.current=[],e();const n=Ve(M.current,e);return M.current=void 0,n}function Dt(e,n,r,o){if(typeof e=="function")return Ft(e);const s=bt(n,r,o);return Array.isArray(e)?Ee(e,s):Ee([e],([i])=>s(i))}function Ee(e,n){const r=A(()=>[]);return Ve(e,()=>{r.length=0;const o=e.length;for(let s=0;s<o;s++)r[s]=e[s].get();return n(r)})}function Vt(e,n={}){const{isStatic:r}=x.useContext(Ae),o=()=>Te(e)?e.get():e;if(r)return Dt(o);const s=De(o());return x.useInsertionEffect(()=>vt(s,e,n),[s,JSON.stringify(n)]),s}function qt({article:e,relatedArticles:n}){var D,V,R,P,U,Y,q,G,X,J,K,Q,Z,ee,te,re,ne,oe,se,ae,ie,le,ce,de,pe,me,fe,he,xe,ue,ge,be,ve,we;const[r,o]=x.useState(()=>typeof window<"u"&&localStorage.getItem("monasbtk_lang")||"en"),[s,i]=x.useState(!1),[l,c]=x.useState(!1),f=x.useRef();x.useEffect(()=>{localStorage.setItem("monasbtk_lang",r)},[r]),x.useEffect(()=>{const d=k=>{f.current&&!f.current.contains(k.target)&&i(!1)};return document.addEventListener("mousedown",d),()=>document.removeEventListener("mousedown",d)},[]);const{data:m,setData:h,post:u,processing:g,reset:y,errors:L}=Xe({content:"",author_name:""}),Re=d=>{d.preventDefault(),u(route("comments.store",e.id),{onSuccess:()=>{y(),alert(r==="en"?"Comment submitted and awaiting approval!":"تم إرسال التعليق وبانتظار الموافقة!")}})},p={en:{by:"By",read:"min read",comments:"Comments",leaveComment:"Write a comment",name:"Your name",comment:"What are your thoughts?",submit:"Post Comment",related:"More from Monasbtk",noComments:"There are currently no comments for this article. Be the first to leave a comment.",home:"Home",blog:"Blog",submitting:"Publishing...",writtenBy:"Written by",backToBlog:"Back to blog",articleDetails:"Article details",quickActions:"Quick actions",published:"Published",readingTime:"Reading time",category:"Category",respectful:"Be respectful. Your comment will appear after approval.",authorBio:"Content creator at Monasbtk, sharing practical ideas, elegant inspiration, and thoughtful perspectives for your special occasions.",share:"Share Story"},ar:{by:"بقلم",read:"دقائق للقراءة",comments:"التعليقات",leaveComment:"اكتب تعليقاً",name:"اسمك",comment:"ما هي أفكارك؟",submit:"نشر",related:"المزيد من مناسبتك",noComments:"لا توجد تعليقات حالياً على هذا المقال. كن أول من يعلق.",home:"الرئيسية",blog:"المدونة",submitting:"جاري النشر...",writtenBy:"بقلم",backToBlog:"العودة للمدونة",articleDetails:"تفاصيل المقال",quickActions:"اختصارات",published:"نُشر في",readingTime:"وقت القراءة",category:"التصنيف",respectful:"يرجى كتابة تعليق محترم. سيظهر تعليقك بعد الموافقة.",authorBio:"كاتب محتوى في مناسبتك، يشارك أفكاراً عملية، وإلهاماً أنيقاً، ورؤى ملهمة تساعدك على صناعة مناسبات أجمل.",share:"مشاركة المقال"}},H=(d=>d?d.replace(/<[^>]*>/g,"").trim():"")((D=e.content)==null?void 0:D[r]),Pe=H?H.split(/\s+/).length:0,O=Math.max(1,Math.ceil(Pe/200)),I=d=>new Date(d).toLocaleDateString(r==="ar"?"ar-EG":"en-US",{month:"long",day:"numeric",year:"numeric"}),F=d=>new Date(d).toLocaleDateString(r==="ar"?"ar-EG":"en-US",{month:"short",day:"numeric"}),w=typeof window<"u"?window.location.href:"",a=r==="ar",{scrollYProgress:Ue}=It(),Ye=Vt(Ue,{stiffness:100,damping:30,restDelta:.001}),qe=()=>{navigator.clipboard.writeText(w),c(!0),setTimeout(()=>c(!1),2e3)},Ge=()=>{navigator.clipboard.writeText(w),alert(r==="en"?"Link copied to clipboard! Share it on your Instagram story.":"تم نسخ رابط المقال! يمكنك الآن مشاركته في قصص إنستغرام.")};return t.jsxs("div",{dir:a?"rtl":"ltr",className:"blog-show-root",style:{background:"#fdf9fb",color:"#2a1f30"},children:[t.jsxs(Je,{title:(V=e.title)==null?void 0:V[r],children:[t.jsx("meta",{name:"description",content:((R=e.short_description)==null?void 0:R[r])||((P=e.title)==null?void 0:P[r])}),t.jsx("meta",{property:"og:title",content:(U=e.title)==null?void 0:U[r]}),t.jsx("meta",{property:"og:description",content:((Y=e.short_description)==null?void 0:Y[r])||((q=e.title)==null?void 0:q[r])}),t.jsx("meta",{property:"og:type",content:"article"}),e.image&&t.jsx("meta",{property:"og:image",content:`/storage/${e.image}`}),t.jsx("script",{type:"application/ld+json",children:JSON.stringify({"@context":"https://schema.org","@type":"Article",headline:(G=e.title)==null?void 0:G[r],description:((X=e.short_description)==null?void 0:X[r])||"",image:e.image?`/storage/${e.image}`:void 0,author:{"@type":"Person",name:(J=e.user)==null?void 0:J.name},datePublished:e.created_at,dateModified:e.updated_at||e.created_at,publisher:{"@type":"Organization",name:"Monasbtk"},mainEntityOfPage:{"@type":"WebPage","@id":w}})})]}),t.jsx("style",{children:`
